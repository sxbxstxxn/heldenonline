 ...
 */
final class Version20200331154321 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chars ADD size VARCHAR(45) DEFAULT NULL, ADD weight VARCHAR(45) DEFAULT NULL, ADD haircolor VARCHAR(45) DEFAULT NULL, ADD eyecolor VARCHAR(45) DEFAULT NULL, CHANGE age age INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chars DROP size, DROP weight, DROP haircolor, DROP eyecolor, CHANGE age age INT DEFAULT NULL');
